...
import { validateReleaseSeatsPayload } from "@/validators/client/booking.validator";
import { releaseSeats } from "@/services/server/client/booking.service";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const payload = validateReleaseSeatsPayload(body);
    ...
    const result = await releaseSeats(payload, userId);
